...
define('TPPOST_SLIDER_PLUGIN_PATH', WP_PLUGIN_URL . '/' . plugin_basename( dirname(__FILE__) ) . '/' );
define('tppost_slider_plugin_dir', plugin_dir_path( __FILE__ ) );


function tppost_slider_load_textdomain(){
	load_plugin_textdomain('tppostslider', false, dirname(plugin_basename( __FILE__ )) . '/languages/');
}
add_action('plugins_loaded', 'tppost_slider_load_textdomain');




function tppost_slider_script_initial(){
	wp_enqueue_style('tppost-slider-transitions-css', TPPOST_SLIDER_PLUGIN_PATH.'css/owl.transitions.css');
	wp_enqueue_style('tppost-slider-slider-css', TPPOST_SLIDER_PLUGIN_PATH.'css/owl.carousel.css');
	wp_enqueue_style('tppost-slider-awesome-css', TPPOST_SLIDER_PLUGIN_PATH.'css/font-awesome.css');
	wp_enqueue_style('tppost-slider-theme-css', TPPOST_SLIDER_PLUGIN_PATH.'css/owl.theme.css');
	wp_enqueue_script('tppost-slider-slider-js', plugins_url( '/js/owl.carousel.js', __FILE__ ), array('jquery'), '1.0', false);
}
add_action('wp_enqueue_scripts', 'tppost_slider_script_initial');
...
function padma_post_slider_register_shortcode($atts, $content = null){
